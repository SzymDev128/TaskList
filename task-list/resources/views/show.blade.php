...
@section('content')
    ...
    <div class="flex gap-2 justify-between row">
        <a href="{{route('tasks.edit',['task'=>$task->id])}}"
           class="rounded-md px-2 py-1 text-center font-medium shadow-sm ring-1 ring-slate-700/10 hover:slate-500 text-slate-500">Edit</a>
